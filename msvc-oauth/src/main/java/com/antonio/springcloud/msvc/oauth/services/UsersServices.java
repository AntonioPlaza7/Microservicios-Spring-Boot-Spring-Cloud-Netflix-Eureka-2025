package com.antonio.springcloud.msvc.oauth.services;
...
import com.antonio.springcloud.msvc.oauth.models.User;
...
public class UsersServices implements UserDetailsService {
    ...
    private final Logger logger = LoggerFactory.getLogger(UsersServices.class);
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        try {
            ...
            logger.error(error);
            tracer.currentSpan().tag("error.login.mensaje", error + ": " + e.getMessage());
