package com.antonio.springcloud.msvc.items.controllers;

import org.springframework.web.bind.annotation.RestController;

import com.antonio.springcloud.msvc.items.models.Item;
import com.antonio.springcloud.msvc.items.services.ItemService;
...
public class ItemController {
    ...
    private final CircuitBreakerFactory cBreackerFactory;
    ...
    public ItemController(@Qualifier("itemServiceWebClient")ItemService service,
        ...
        this.cBreackerFactory = cBreakerFactory;
    ...
    public ResponseEntity<?> detail(@PathVariable Long id) {
        Optional<Item> itemOptional = cBreackerFactory.create("items").run(() -> service.findById(id), e -> {
    ...
    @io.github.resilience4j.circuitbreaker.annotation.CircuitBreaker(name="items", fallbackMethod = "getFallBackMethodProduct")
    ...
    @io.github.resilience4j.circuitbreaker.annotation.CircuitBreaker(name="items", fallbackMethod = "getFallBackMethodProduct2")
